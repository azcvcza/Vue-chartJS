				...
				<div class="Search__container">
					...
					<div class="Search__settings" v-if="showSettings">
						<datepicker
							...
							v-model="periodStart"
							name="start-date"
							v-on:selected="validateDataRequest()"
						></datepicker>
						<datepicker
							input-class="Search__input"
		...
		metaInfo() {
			return {
				title: this.packageName
					? `${this.packageName} | 📈 npm-stats`
					: "📈 npm-stats | Download statistics for your npm packages",
				meta: [
					{
						vmid: "description",
						name: "description",
						content:
							"View your npm package download statistics with beautiful charts"
					}
				]
			};
		},
